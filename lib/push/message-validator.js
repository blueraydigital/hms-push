...
const PriorityHight = "HIGH", PriorityNormal = "NORMAL";
const ImportanceHight = "HIGH", ImportanceNormal = "NORMAL", ImportanceLow = "LOW";
const DirAuto = "auto", DirLtr = "ltr", DirRtl = "rtl";
const UrgencyHight = "high", UrgencyNormal = "normal", UrgencyLow = "low", UrgencyVeryLow = "very-low";
const SytleBigText = 1, SytleBigPicture = 2;
const TypeIntent = 1, TypeUrl = 2, TypeApp = 3, TypeRichResource = 4;
...
function validateAndroidConfig(androidConfig, notification) {
    ...
    if (validator.isNonEmptyString(androidConfig.urgency) &&
